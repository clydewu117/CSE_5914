...
export default function CreatePlanPage() {
  ...
  return (
    <div className="min-h-screen p-8 sm:p-20 font-sans">
      <main className="max-w-3xl mx-auto bg-white/60 dark:bg-black/60 p-8 rounded-xl shadow-md">
        ...
        <p className="mb-6 text-sm text-muted-foreground">
          Answer a few quick questions and your preferences will be saved locally as you type.
        </p>
        ...
        <form className="grid gap-4">
          ...
          <div className="flex gap-3 mt-4">
            <button
              type="button"
              onClick={() => alert("Answers saved locally — you can continue editing or navigate away.")}
        ...
        <section className="mt-6 text-sm text-muted-foreground">
          <h3 className="font-medium mb-2">Current answers (live)</h3>
          <pre className="bg-black/[.04] dark:bg-white/[.04] p-3 rounded text-xs overflow-auto">{JSON.stringify(answers, null, 2)}</pre>
        </section>
      </main>
    </div>
  );
